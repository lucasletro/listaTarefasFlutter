...
class _HomeState extends State<Home> {
  ...
  Future<File> _getFile() async {                                      //obter o arquivo. sempre que precisar do arquivo basta chamar o _getfile que ele vai pegar o arquivo que vou utilizar pra salvar os meus dados.
    final directory = await getApplicationDocumentsDirectory();       //essa funçao vai pegar o local onde eu posso armazenar os documentos do meu app, ele esta no diretorio.
  ...
  Future<String> _readData() async {                                     //funçao para ler os dados no arquivo.
    try {
